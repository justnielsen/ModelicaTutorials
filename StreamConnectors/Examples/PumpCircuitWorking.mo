...
model PumpCircuitWorking
  "Closed circuit to show how to fix problem"
...
equation
  ...
  connect(multiSensor1.port_b, pipe1.port_a) annotation (Line(points={{-3,0},
          {10,0},{10,-30},{19,-30}}, color={0,0,0}));
  ...
  connect(multiSensor4.port_b, multiSensor2.port_a) annotation (Line(points=
         {{57,-30},{70,-30},{70,0},{77,0}}, color={0,0,0}));
  connect(multiSensor.port_a, multiSensor2.port_b) annotation (Line(points={
          {-59,0},{-80,0},{-80,-70},{100,-70},{100,0},{83,0}}, color={0,0,0}));
  connect(pressureBoundary_h.port, multiSensor.port_a)
    annotation (Line(points={{-99,0},{-59,0}}, color={0,0,0}));
  annotation (preferredView="diagram", Diagram(coordinateSystem(extent={{-120,
            -100},{120,100}}, initialScale=0.1), graphics={Text(
              extent={{-118,98},{-60,92}},
              lineColor={0,0,0},
